...
export const APIBrasilRealtimeSection: React.FC<APIBrasilRealtimeSectionProps> = ({
  ...
  const fetchStatusAndQR = useCallback(async () => {
    ...
    try {
      ...
      try {
        // generateQRCode espera: token e profileId
        const qrRes = await generateQRCode(apiToken, profileId);
  ...
  return (
    <div className="bg-green-900/30 border-2 border-green-500 rounded-xl p-6 mb-6 flex flex-col items-center">
        ...
        <div className="flex flex-col items-center w-full">
          <div className="mb-4 w-full flex flex-col items-center">
            ...
            <div className="text-center">
              <h3 className="text-2xl font-bold text-white mb-2">Escaneie o QR Code no WhatsApp (MODO LOCAL)</h3>
