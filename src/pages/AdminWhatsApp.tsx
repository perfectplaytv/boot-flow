...
const AdminWhatsApp: React.FC = () => {
  ...
  return (
    <WhatsAppStatusContext.Provider value={{ isConnected, connectionStatus: connectionStatus as any, setIsConnected, setConnectionStatus: setConnectionStatus as any }}>
