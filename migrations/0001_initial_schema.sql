...
CREATE UNIQUE INDEX IF NOT EXISTS `resellers_username_unique` ON `resellers` (`username`);
CREATE UNIQUE INDEX IF NOT EXISTS `resellers_email_unique` ON `resellers` (`email`);
